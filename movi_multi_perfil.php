...
foreach ($ArrPerfilesPorUsuario as $item) {
   ...
   if( $ContadorPrivilegios > CERO){
       ...
       elseif($item=="2") {
        ...
        elseif($item=="3") {
            $Msg= "Administracion de recurso, gestion de  roles del sistema y control de acceso.";
               $Ico ="corporate-researcher-icon";
            $DataClass ="company";   
...
<meta property="og:title" content="Data Tracing">
...
<link rel="shortcut icon" href="https://www.banamex.com/favicon.ico">
